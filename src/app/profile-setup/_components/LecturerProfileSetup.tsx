        ...
        <div className="mb-8 flex items-center justify-center gap-2">
          {[1, 2].map((s) => (
            <div key={s} className="flex items-center gap-2">
              ...
              {s < 2 && <div className={`h-0.5 w-16 transition ${step > s ? "bg-violet-600" : "bg-gray-200"}`} />}
            </div>
          ))}
        </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          {step === 1 && (
            <div className="space-y-5">
              ...
              <div>
                <label className="mb-1.5 block text-sm font-medium text-gray-700">LinkedIn URL <span className="text-gray-400">(optional)</span></label>
                <input
                  type="url"
                  value={linkedinUrl}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. PhD Computer Science - University of Colombo, MSc Data Science - University of Moratuwa"
                  rows={3}
                  className="w-full rounded-lg border border-gray-200 px-4 py-3 text-sm outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-100"
                />
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-gray-700">Hourly Rate (LKR) <span className="text-gray-400">(optional)</span></label>
                  <input
                    type="number"
                    value={hourlyRate}
              ...
              <div>
                <label className="mb-1.5 block text-sm font-medium text-gray-700">Bio <span className="text-gray-400">(optional)</span></label>
                <textarea
                  value={bio}
